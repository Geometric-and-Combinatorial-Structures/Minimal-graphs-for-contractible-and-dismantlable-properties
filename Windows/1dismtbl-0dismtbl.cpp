/*
This program runs over the connected graphs, up to 8 vertices, and identify those graphs 1-dismantlables but not 0-dismantlables.
*/
...
//Compute the neighborhood of the vertex v_i
...
int main(){
    ...
    OF=fopen("1dismtbl-0dismtbl.dat","w");
    Cont=0;
    for(V=1;V<=8;V++){
